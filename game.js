(() => {
  ...
  function indoorFurniture(){
    ...
    if(interior.jobId){
      ...
      else if(kind==='clean'){for(const [i,c] of ['#7197b7','#80a57b','#baa46f'].entries()){add(-7+i*7,4,3,3,1.8,c);add(-7+i*7,4,3.2,3.2,2,'#50676a');}}
