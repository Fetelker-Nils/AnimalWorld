...
function createDeliveryJob(storage, world) {
  ...
  function save(){
    try { storage.setItem(key, JSON.stringify({coins,completed,ownedHomes,homeId,ownedOutfits,outfitId})); storageAvailable=true; }
    catch { storageAvailable=false; }
  }
  ...
  function purchaseHome(id){
    ...
    const next={coins:coins-house.price,completed,ownedHomes:[...ownedHomes,id],homeId:homeId||id,ownedOutfits,outfitId};
  ...
  function setHome(id){
    ...
    try{storage.setItem(key,JSON.stringify({coins,completed,ownedHomes,homeId:id,ownedOutfits,outfitId}));}
  ...
  function purchaseOutfit(id){
    ...
    const next={coins:coins-outfit.price,completed,ownedHomes,homeId,ownedOutfits:[...ownedOutfits,id],outfitId:id};
  ...
  function equipOutfit(id){
    ...
    try{storage.setItem(key,JSON.stringify({coins,completed,ownedHomes,homeId,ownedOutfits,outfitId:id}));}catch{storageAvailable=false;return false;}
